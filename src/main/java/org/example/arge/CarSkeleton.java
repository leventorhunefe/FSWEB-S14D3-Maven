...
public class CarSkeleton {
    ...
    // CarSkeleton sınıfının istenilen metotları
    ...
    public void runEngine(CarSkeleton carSkeleton){
        // Downcasting yapılacak (Upcasting polimorphism i sağlar ama downcasting böyle değil)
        if(carSkeleton instanceof ElectricCar){
            ...
            System.out.println("The car engine is starting with gaspowered car: per liter: " + gasPoweredCar.getAverageKmPerLiter());
        } else {
